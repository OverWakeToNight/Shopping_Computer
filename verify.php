...
if ( (!isset($_REQUEST['email'])) || (isset($_REQUEST['token'])) )
{
    ...
    if($var != 0)
    {
        ...
        $success_message = '<p style="color:green;">Email của bạn được xác minh thành công. Bây giờ bạn có thể đăng nhập vào trang web của chúng tôi.</p><p><a href="'.BASE_URL.'login.php" style="color:#167ac6;font-weight:bold;">Nhấp vào đây để đăng nhập</a></p>';     
    }
}
?>
