		...
		<div class="col-md-12">
			...
			<form class="form-horizontal" action="" method="post">
				<div class="box box-info">
					<div class="box-body">						
						<p style="padding-bottom: 20px;">Nếu bạn không muốn hiển thị một phương tiện truyền thông xã hội trong trang kết thúc trước của bạn, chỉ cần để trống trường nhập liệu.</p>
