...
if(isset($_POST['form1'])) {
    ...
    if($_POST['adv_type'] == 'Image Advertisement') {
        ...
        if(empty($_POST['adv_adsense_code'])) {
            $valid = 0;
            $error_message .= 'Bạn phải cung cấp cho một mã AdSense <br>';
        }
    }
    ...
    if($valid == 1) {
        ...
        $success_message = 'Quảng cáo được cập nhật thành công.';
    }
}
...
if(isset($_POST['form3'])) {
    ...
    if($_POST['adv_type'] == 'Image Advertisement') {
        ...
        if($path != '') {
            ...
            if( $ext!='jpg' && $ext!='png' && $ext!='jpeg' && $ext!='gif' ) {
                $valid = 0;
                $error_message .= 'Bạn phải tải lên tệp JPG, JPEG, GIF hoặc PNG file<br>';
            }
        }
    } else {
        if(empty($_POST['adv_adsense_code'])) {
        ...
        <div class="col-md-12">
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#tab_1" data-toggle="tab">Trên phần Chào Mừng</a></li>
                        <li><a href="#tab_2" data-toggle="tab">Sản phẩm nổi bật</a></li>
                        <li><a href="#tab_3" data-toggle="tab">Sản phẩm mới nhất</a></li>
                        <li><a href="#tab_4" data-toggle="tab">Sản phẩm phổ biến</a></li>
                        <li><a href="#tab_5" data-toggle="tab">Phần nhận xét khách hàng</a></li>
                        <li><a href="#tab_6" data-toggle="tab">Danh mục chuyển trang</a></li>
                    </ul>
                                ...
                                <div class="box box-info">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="" class="col-sm-3 control-label">Loại</label>
                                            <div class="col-sm-6" style="width:auto;">
                                                <select name="adv_type" class="form-control" onchange="funcTab1(this)">
                                                    <?php
                                                    if($adv_type[0] == 'Image Advertisement') {
                                                        ?>
                                                            <option value="Image Advertisement" selected>Quảng cáo hình ảnh</option>
                                                            <option value="Adsense Code">Mã Quảng cáo</option>
                                                        <?php
                                                    } else {
                                                        ?>
                                                            <option value="Image Advertisement">Quảng cáo hình ảnh</option>
                                                            <option value="Adsense Code" selected>Mã Quảng cáo</option>
                                                        <?php
                                                    }
                                                    ?>
                                                </select>
                                        ...
                                        <div class="form-group" id="tabField1">
                                            <label class="col-sm-3 control-label">Hình ảnh tồn tại</label>
                                        ...
                                        <div class="form-group" id="tabField2">
                                            <label class="col-sm-3 control-label">Hình mới<br><span style="font-size:12px;font-weight:normal;">(Recommended Width: 1170 pixels and Height: any size)</span></label>
                                            <div class="col-sm-5" style="padding-top:5px;">
                                        ...
                                        <div class="form-group" id="tabField4">
                                            <label class="col-sm-3 control-label">Mã Quảng cáo</label>
                                            <div class="col-sm-8">
                                ...
                                <div class="box box-info">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group" id="tabField6">
                                            <label class="col-sm-3 control-label">Hình ảnh mới<br><span style="font-size:12px;font-weight:normal;">(Recommended Width: 1170 pixels and Height: any size)</span></label>
                                            <div class="col-sm-5" style="padding-top:5px;">
                                                <input type="file" name="photo">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-6" style="width:auto;">
                                                <select name="adv_type" class="form-control"onchange="funcTab3(this)">
                                                    ...
                                                    if($adv_type[2] == 'Image Advertisement') {
                                                        ?>
                                                            <option value="Image Advertisement" selected>Hình ảnh quảng cáo</option>
                                                            <option value="Adsense Code">Mã Quảng cáo</option>
                                                        <?php
                                                    } else {
                                                        ?>
                                                            <option value="Image Advertisement">Hình ảnh quảng cáo</option>
                                                            <option value="Adsense Code" selected>Mã quảng cáo</option>
                                                        <?php
                                                    }
                                                    ?>
                                ...
                                <div class="box box-info">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group" id="tabField22">
                                            <label class="col-sm-3 control-label">Hình ảnh mới<br><span style="font-size:12px;font-weight:normal;">(Recommended Width: 260 pixels and Height: any size)</span></label>
                                            <div class="col-sm-5" style="padding-top:5px;">
                                                <input type="file" name="photo">
                                            </div>
                                        </div>
