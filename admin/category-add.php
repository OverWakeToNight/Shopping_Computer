...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="category.php" class="btn btn-primary btn-sm">Xem tất cả</a>
	</div>
</section>
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" name="category_name" placeholder="Ví dụ:Laptop">
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Danh mục phụ </label>
							<div class="col-sm-4">
								<input type="text" class="form-control" name="category_slug" placeholder="Ví dụ:Laptop giá...">
							</div>
						</div>
